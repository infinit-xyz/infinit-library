...
abstract class SubAction<P extends object = {}, R extends object = {}, M extends object = {}> {
   ...
   */
  public async checkCache(transactionCaches?: TransactionCache[], callback?: InfinitCallback): Promise<number> {
   ...
   */
  public async execute(registry: R, data?: SubActionData, callback?: InfinitCallback): Promise<SubActionExecuteResponse<R, M>> {
