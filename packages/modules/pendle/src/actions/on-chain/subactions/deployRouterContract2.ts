...
export type DeployPendleRouterContractMsg = {
...
> {
  ...
  public async updateRegistryAndMessage(
    ...
    txHashes: Hex[],
  ): Promise<SubActionExecuteResponse<PendleRegistry, DeployPendleRouterContractMsg>> {
    ...
    const newMessage: DeployPendleRouterContractMsg = {
      pendleRouterV4,
      pendleRouterStatic,
