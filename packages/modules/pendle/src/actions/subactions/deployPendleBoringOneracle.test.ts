...
import { DeployPendleBoringOneracleMsg, DeployPendleBoringOneracleSubAction } from '@actions/subactions/deployPendleBoringOneracle'
...
describe('DeployPendleBoringOneracleSubAction', () => {
  ...
  let result: SubActionExecuteResponse<PendleRegistry, DeployPendleBoringOneracleMsg>
