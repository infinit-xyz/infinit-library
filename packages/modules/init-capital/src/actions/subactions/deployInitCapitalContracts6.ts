...
export class DeployInitCapitalContracts6SubAction extends SubAction<DeployInitCapitalContracts_6SubActionParams, InitCapitalRegistry, DeployInitCapitalMsg_6> {
  ...
  protected setTxBuilders(): void {
    // ----------- initialize -----------
    this.txBuilders.push(new InitializePosManagerTxBuilder(this.client, {
    ...
    this.txBuilders.push(new InitializeInitCoreTxBuilder(this.client, {
      initCore: this.params.initCoreProxy,
    ...
    // ----------- lens -----------
    this.txBuilders.push(new DeployInitLensTxBuilder(this.client, {
      initCore: this.params.initCoreProxy,
      posManager: this.params.posManagerProxy,
      riskManager: this.params.riskManagerProxy,
      config: this.params.configProxy,
