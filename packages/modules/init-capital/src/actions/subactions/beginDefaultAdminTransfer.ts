...
export class BeginDefaultAdminTransferSubAction extends SubAction<
  BeginDefaultAdminTransferSubActionParams,
  InitCapitalRegistry,
  BeginDefaultAdminTransferMsg
> {
  ...
  protected setTxBuilders(): void {
    ...
    this.txBuilders.push(
      new BeginDefaultAdminTransferTxBuilder(this.client, {
