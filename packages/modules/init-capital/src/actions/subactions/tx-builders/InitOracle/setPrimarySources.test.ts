...
describe('SetPrimarySourcesTxBuilder', async () => {
  let txBuilder: SetPrimarySourcesTxBuilder
  const client = new TestInfinitWallet(TestChain.arbitrum, tester)

  test('test calldata', async () => {
    txBuilder = new SetPrimarySourcesTxBuilder(client, {
  ...
  test('test validate should be passed', async () => {
    ...
    txBuilder = new SetPrimarySourcesTxBuilder(client2, {
