...
export type SetSecondarySourcesParams = {
  initOracle: Address
  tokens: Address[]
  sources: Address[]
}

export class SetSecondarySourcesTxBuilder extends TxBuilder {
  public initOracle: Address
  public tokens: Address[]
  public sources: Address[]

  constructor(client: InfinitWallet, params: SetSecondarySourcesParams) {
    super(SetSecondarySourcesTxBuilder.name, client)
