...
import { RemoveRiskAdminAction } from '@actions/removeRiskAdmin'
import { RemoveRiskAdminSubAction } from '@actions/subactions/removeRiskAdmin'

import { TestChain, TestInfinitWallet } from '@infinit-xyz/test'

vi.mock('@actions/subactions/removeRiskAdmin')

describe('RemoveRiskAdminAction', () => {
  let action: RemoveRiskAdminAction
  ...
  describe('run', () => {
    action = new RemoveRiskAdminAction({
      params: {
        riskAdmin: bob,
      },
      signer: {
    ...
    test('should run sub-actions successfully', async () => {
      const mockSubActionExecute = vi.mocked(RemoveRiskAdminSubAction.prototype.execute)
    ...
    test('should throw an error if sub-action validation fails', async () => {
      const mockSubActionValidate = vi.mocked(RemoveRiskAdminSubAction.prototype.validate)
    ...
    test('should handle callback correctly', async () => {
      ...
      const mockSubAction = vi.mocked(RemoveRiskAdminSubAction.prototype)
