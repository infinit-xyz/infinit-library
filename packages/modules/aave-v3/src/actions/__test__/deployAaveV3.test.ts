...
describe('deployAaveV3Action', () => {
  ...
  test('simple run (all roles are deployer)', async () => {
    ...
    expect(curRegistry.poolAddressProviderRegistry).not.toBe(zeroAddress)
    expect(curRegistry.supplyLogic).not.toBe(zeroAddress)
    expect(curRegistry.borrowLogic).not.toBe(zeroAddress)
    expect(curRegistry.liquidationLogic).not.toBe(zeroAddress)
    expect(curRegistry.eModeLogic).not.toBe(zeroAddress)
    expect(curRegistry.bridgeLogic).not.toBe(zeroAddress)
    expect(curRegistry.configuratorLogic).not.toBe(zeroAddress)
    expect(curRegistry.poolLogic).not.toBe(zeroAddress)
    expect(curRegistry.aaveEcosystemReserveV2Proxy).not.toBe(zeroAddress)
    expect(curRegistry.aaveEcosystemReserveController).not.toBe(zeroAddress)
    expect(curRegistry.aaveEcosystemReserveV2Impl).not.toBe(zeroAddress)
    expect(curRegistry.poolAddressesProvider).not.toBe(zeroAddress)
    expect(curRegistry.reservesSetupHelper).not.toBe(zeroAddress)
    expect(curRegistry.walletBalanceProvider).not.toBe(zeroAddress)
    expect(curRegistry.uiIncentiveDataProvider).not.toBe(zeroAddress)
    expect(curRegistry.uiPoolDataProviderV3).not.toBe(zeroAddress)
    expect(curRegistry.aaveProtocolDataProvider).not.toBe(zeroAddress)
    expect(curRegistry.flashLoanLogic).not.toBe(zeroAddress)
    expect(curRegistry.poolConfiguratorImpl).not.toBe(zeroAddress)
    expect(curRegistry.aclManager).not.toBe(zeroAddress)
    expect(curRegistry.aaveOracle).not.toBe(zeroAddress)
    expect(curRegistry.l2PoolImpl).not.toBe(zeroAddress)
    expect(curRegistry.poolProxy).not.toBe(zeroAddress)
    expect(curRegistry.poolConfiguratorProxy).not.toBe(zeroAddress)
    expect(curRegistry.wrappedTokenGatewayV3).not.toBe(zeroAddress)
    expect(curRegistry.l2Encoder).not.toBe(zeroAddress)
    expect(curRegistry.aTokenImpl).not.toBe(zeroAddress)
    expect(curRegistry.delegationAwareATokenImpl).not.toBe(zeroAddress)
    expect(curRegistry.stableDebtTokenImpl).not.toBe(zeroAddress)
    expect(curRegistry.variableDebtTokenImpl).not.toBe(zeroAddress)
  ...
  test('simple run (different addreses on each roles + no init reserves)', async () => {
    ...
    const owner = await client.publicClient.readContract({
      address: curRegistry.poolAddressesProvider!,
