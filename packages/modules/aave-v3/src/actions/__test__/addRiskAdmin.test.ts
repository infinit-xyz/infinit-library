...
import { AddRiskAdminAction } from '@actions/addRiskAdmin'
import { AddRiskAdminSubAction } from '@actions/subactions/addRiskAdmin'

import { TestChain, TestInfinitWallet } from '@infinit-xyz/test'

vi.mock('@actions/subactions/addRiskAdmin')

describe('AddRiskAdminAction', () => {
  let action: AddRiskAdminAction
  ...
  describe('run', () => {
    ...
    test('should run sub-actions successfully', async () => {
      const mockSubActionExecute = vi.mocked(AddRiskAdminSubAction.prototype.execute)
    ...
    test('should throw an error if sub-action validation fails', async () => {
      const mockSubActionValidate = vi.mocked(AddRiskAdminSubAction.prototype.validate)
    ...
    test('should handle callback correctly', async () => {
      ...
      const mockSubAction = vi.mocked(AddRiskAdminSubAction.prototype)
