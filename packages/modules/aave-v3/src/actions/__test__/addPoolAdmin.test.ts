...
import { AddPoolAdminAction } from '@actions/addPoolAdmin'
import { AddPoolAdminSubAction } from '@actions/subactions/addPoolAdmin'

import { TestChain, TestInfinitWallet } from '@infinit-xyz/test'

vi.mock('@actions/subactions/addPoolAdmin')

describe('AddPoolAdminAction', () => {
  let action: AddPoolAdminAction
  ...
  describe('run', () => {
    ...
    test('should run sub-actions successfully', async () => {
      const mockSubActionExecute = vi.mocked(AddPoolAdminSubAction.prototype.execute)
    ...
    test('should throw an error if sub-action validation fails', async () => {
      const mockSubActionValidate = vi.mocked(AddPoolAdminSubAction.prototype.validate)
    ...
    test('should handle callback correctly', async () => {
      ...
      const mockSubAction = vi.mocked(AddPoolAdminSubAction.prototype)
